            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_place">
                    <div class="thumb">
                        ...
                        <a href="#" class="prise">{{ $produk->wisata_kota }}</a>
                    </div>
                    <div class="place_info">
                        <a href="{{ route('detail-wisata', $produk->id) }}"><h3>{{ $produk->wisata_nama }}</h3></a>
                        {{-- <p>Jl. Kolagana, Palabusa, Kec. Bungi, Kota Bau-Bau.</p> --}}
                        <p>{{ $produk->wisata_kota }} / {{ $produk->wisata_kelurahan }} / {{ $produk->wisata_kecamatan }}</p>
