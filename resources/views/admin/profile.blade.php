            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-md-7 col-lg-7">
                        <p>
                            : <span class="text-dark"> {{ $users->login_nama }} </span> <br>
                            : <span class="text-dark"> {{ $users->login_username }} </span> <br>
                            : <span class="text-dark"> {{ $users->login_email }} </span> <br>
                            : <button class="btn btn-sm btn-success">{{ strtoupper($users->login_status) }}</button> <br>
                            : <span class="text-dark"> {{ $users->login_telepon }} </span> <br>
                        </p>
                    </div>
                </div>
            </div>
