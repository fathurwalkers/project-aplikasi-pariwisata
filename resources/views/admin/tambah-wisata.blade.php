    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post-tambah-wisata') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="wisata_nama" type="text" class="form-control" id="wisata_nama" placeholder="Masukkan nama tempat wisata...">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="wisata_kota" type="text" class="form-control" id="wisata_kota" placeholder="Masukkan tempat/kabupaten/kota/desa wisata...">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input name="wisata_maps" type="text" class="form-control" id="wisata_maps" placeholder="Masukkan tempat/kabupaten/kota/desa wisata...">
                                {{-- <small id="emailHelp" class="form-text text-muted">contoh : Pasarwajo</small> --}}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="wisata_kecamatan" type="text" class="form-control" id="wisata_kecamatan" placeholder="Masukkan tempat/kabupaten/kota/desa wisata...">
                                <small id="emailHelp" class="form-text text-muted">contoh : Pasarwajo</small>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="wisata_kelurahan" type="text" class="form-control" id="wisata_kelurahan" placeholder="Masukkan tempat/kabupaten/kota/desa wisata...">
                                <small id="emailHelp" class="form-text text-muted">contoh : Pasarwajo</small>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input name="wisata_provinsi" type="text" class="form-control" id="wisata_provinsi" placeholder="Masukkan tempat/kabupaten/kota/desa wisata...">
                                <small id="emailHelp" class="form-text text-muted">contoh : Pasarwajo</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <textarea name="wisata_deskripsi" id="wisata_deskripsi"></textarea>
                        </div>
                    </div>
