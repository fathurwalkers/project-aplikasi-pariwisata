    ...
    <div class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        <h4 class="text-bold text-dark">Ubah Kategori - {{ $kategori->kategori_nama }}</h4>
                    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('post-update-kategori', $kategori->id) }}" method="POST">
                    @csrf
                    @error('kategori_nama')
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="kategori_nama" type="text" class="form-control @error('kategori_nama') is-invalid @enderror" id="kategori_nama" placeholder="Masukkan nama kategori..." value="{{ $kategori->kategori_tipe }}">
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select name="kategori_tipe" class="form-control @error('kategori_tipe') is-invalid @enderror" id="kategori_tipe">
                                    <option value="{{ $kategori->kategori_tipe }}" selected>{{ $kategori->kategori_tipe }}</option>
